...
export default function Chat() {
  ...
  const handleFileUpload = async (e) => {
    ...
    try {
      ...
      console.log("Fuzzy Chart:", res.data.fuzzy_chart);
      ...
      // Add fuzzy charts SAFELY
      if (res.data.fuzzy_chart) {
        setMessages(prev => [
          ...prev,
          {
            sender: "agent",
      ...
      <div className="chat-box" ref={chatBoxRef}>
        {messages.map((msg, i) => (
          ...
          >
            ...
            {/* SAFE FUZZY RENDER */}
            {!msg.thinking && msg.type === "fuzzy" && msg.fuzzy && (
              <>
                {msg.fuzzy.rating && (
                  <FuzzyChart
